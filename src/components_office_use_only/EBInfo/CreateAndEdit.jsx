...
/**   useDynamicValuesEBPaidStatus,
  useDynamicValuesEBCalculationStatus,
...
export const CreateAndEdit = ({
  ...
  // useEffect(() => {
  //   fetch("http://localhost:4000/api/properties-data")
  //     .then((res) => res.json())
  //     .then((res) => {
  //       // res.data is the ARRAY
  //       const propertyCodes = res.data.map((item) => item.PropertyCode);
